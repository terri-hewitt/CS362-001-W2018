	 ...
	 @Test
	  public void test02()  throws Throwable  {
		 ...
		 Appt appt = new Appt(startHour,
				 ...
				 description);
		 int i[] = {1, 2, 3};
		 appt.setDescription("Birthday party");
		 appt.setRecurrence(i, Appt.RECUR_BY_MONTHLY, 0, Appt.RECUR_NUMBER_NEVER);
		 // assertions
		 assertTrue(appt.getValid());
		 assertEquals(21, appt.getStartHour());
		 assertEquals(30, appt.getStartMinute());
		 ...
		 assertEquals("Birthday Party", appt.getTitle());
//		 assertEquals("This is my birthday party.", appt.getDescription());
         assertEquals(i, appt.getRecurDays());
		 ...
		 assertEquals(-54, appt2.compareTo(appt));
...
//		assertEquals(0, appt.getRecurDays());
	...
	//	int startMonth = 14;
		...
		// assertions
	//	assertEquals(false, appt.getValid());
		assertEquals("\t"+"1/24/2018 at " + "3:30pm"+" ," + "Start month error, null\n", appt.toString());
		appt.setStartHour(0);
		assertEquals("\t"+"1/24/2018 at " + "12:30am"+" ," + "Start month error, null\n", appt.toString());
	//	appt.toString();
		assertEquals(true, appt.getValid());
