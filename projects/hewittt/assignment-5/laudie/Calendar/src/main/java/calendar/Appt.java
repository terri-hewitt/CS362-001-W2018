...
public class Appt implements  Comparable<Appt>{
    ...
    private void isValid() {
    	...
    	if(startHour<0 && startHour>23) //Bug #1 impossible to set an invalid starthour, need to change && to ||
    		this.valid=false;
    	else
        	if(startMinute<0 || startMinute>59)
            	...
            	if(startDay<1 || startDay>NumDaysInMonth)
                	...
                	if(startMonth<1 || startMonth>12)   //Bug#3: should be startMonth<0 || startMonth>11
                		this.valid=false;
                	else
                		this.valid=true;
    }
